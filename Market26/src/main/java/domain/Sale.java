...
public class Sale implements Serializable {
	...
	private java.util.List<CounterOffer> counterOffers = new java.util.ArrayList<CounterOffer>();
	...
	// --- Métodos para las Contraofertas ---
	public java.util.List<CounterOffer> getCounterOffers() {
		return counterOffers;
	}

	public void setCounterOffers(java.util.List<CounterOffer> counterOffers) {
